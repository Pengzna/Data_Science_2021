...
def save_doc_to_docx(rawpath, outpath):  # doc转docx
    '''
...
if __name__ == '__main__':
    # 注意：目录的格式必须写成双反斜杠,不能用相对路径
    rawpath = 'C:\\Users\\wbl\\Desktop\\case\\case_docx\\'
    outpath = 'C:\\Users\\wbl\\Desktop\\case\\case_txt_lxy\\'
    save_doc_to_docx(rawpath, outpath)
    print('ok.')
